...
![在这里插入图片描述](https://img-blog.csdnimg.cn/2019090918133764.jpg)![在这里插入图片描述](https://img-blog.csdnimg.cn/20190909180141364.jpg?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2piajY1Njg4Mzl6,size_16,color_FFFFFF,t_70)
```js
/**
 * @param {string[]} strs
 * @return {string}
