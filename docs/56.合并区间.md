...
* 1.对所有区间的边界进行排序
* 2.对新生成的区间进行比较合并
![在这里插入图片描述](https://img-blog.csdnimg.cn/20190920115226507.jpg?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2piajY1Njg4Mzl6,size_16,color_FFFFFF,t_70)
```js
